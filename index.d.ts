...
export interface paths {
  ...
  "/api/2/delivery_restrictions": {
    /** Get delivery restrictions (v2). */
    post: {
      parameters: {
        header: {
          /** @description Authorization token. */
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.GetDeliveryRestrictionsRequest"];
        };
      };
      responses: {
        /** @description Success */
        200: {
          content: {
            "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.GetDeliveryRestrictionsResponse"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/api/2/delivery_restrictions/allowed": {
    /** Get suitable terminal groups for delivery restrictions (v2). */
    post: {
      parameters: {
        header: {
          /** @description Authorization token. */
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.GetAllowedRestrictionsRequest"];
        };
      };
      responses: {
        /** @description Success */
        200: {
          content: {
            "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.GetAllowedRestrictionsResponse"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/api/1/deliveries/drafts/by_id": {
    ...
    post: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.GetDraftRequest"];
        };
      };
      responses: {
        /** @description Success */
        200: {
          content: {
            "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.GetDraftResponse"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/api/1/deliveries/drafts/by_filter": {
    ...
    post: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.FilterDraftsRequest"];
        };
      };
      responses: {
        /** @description Success */
        200: {
          content: {
            "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.FilterDraftsResponse"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/api/1/deliveries/drafts/save": {
    ...
    post: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.SaveDraftRequest"];
        };
      };
      responses: {
        /** @description Success */
        200: {
          content: {
            "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.SaveDraftResponse"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/api/1/deliveries/drafts/commit": {
    ...
    post: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.CommitDraftRequest"];
        };
      };
      responses: {
        /** @description Success */
  ...
  "/api/1/deliveries/drafts/delete": {
    ...
    post: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.DeleteDraftRequest"];
        };
      };
      responses: {
        /** @description Success */
...
export interface components {
  schemas: {
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.AddMagnetCardResponse": Record<string, never>;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.CancelHoldMoneyResponse": Record<string, never>;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.ChangeCategoryForCustomerResponse": Record<string, never>;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.DeleteMagnetCardResponse": Record<string, never>;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.GetCustomerInfoByCardNumberRequest": {
      ...
      cardNumber?: string;
    } & Omit<components["schemas"]["iikoNet.Service.Contracts.Api.iikoTransport.Customer.GetCustomerInfoRequest"], "type">;
     ...
     * @enum {integer}
     */
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.IikoNetUserSex": 0 | 1 | 2;
    /**
     * Format: int32 
     * @enum {integer}
     */
    "iikoNet.Service.Contracts.Api.iikoTransport.Customer.PersonalDataConsentStatus": 0 | 1 | 2;
     ...
     * @enum {integer}
     */
    "iikoNet.Service.Contracts.Api.iikoTransport.LoyaltyResult.ComboPriceModificationType": 0 | 1 | 2 | 3 | 4;
     ...
     * @enum {integer}
     */
    "iikoNet.Service.Contracts.Api.iikoTransport.LoyaltyResult.OperationCode": 0 | 1 | 2 | 3;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Organization.LoyaltyProgram": {
       ...
       */
      templateType?: components["schemas"]["iikoNet.Service.Contracts.Api.iikoTransport.TemplateType"];
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Organization.RefillUserBalanceResponse": Record<string, never>;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Organization.SendEmailResponse": Record<string, never>;
    ...
    "iikoNet.Service.Contracts.Api.iikoTransport.Organization.SendSmsResponse": Record<string, never>;
    /** @description Withdraw user balance response. */
    "iikoNet.Service.Contracts.Api.iikoTransport.Organization.WithdrawUserBalanceResponse": Record<string, never>;
    /**
     * Format: int32 
     * @description Corporate program type. 
     * @enum {integer}
     */
    "iikoNet.Service.Contracts.Api.iikoTransport.ProgramType": 0 | 1 | 2 | 3 | 4;
    /**
     * Format: int32 
     * @enum {integer}
     */
    "iikoNet.Service.Contracts.Api.iikoTransport.TemplateType": 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8;
    ...
    "iikoTransport.PublicApi.Contracts.Address.CitiesResponse": {
      ...
      cities: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Address.City, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Address.RegionsResponse": {
      ...
      regions: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Address.Region, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.AddressHints.AddressHintsServiceType": "DaData" | "GetAddress";
    ...
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Commands.GetCommandStatusResponse"], "state">;
    ...
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Address.City, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Address.Region, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Discounts.DiscountCardTypeInfo, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.ActiveCourierLocation, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.CourierLocations, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.Employee, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.EmployeeWithCheckedRole, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.OrderTypes.OrderType, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.StopLists.TerminalGroupStopList, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    /** @description RMS pair wrapping - list of response items that belong to this RMS. */
    "iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Terminals.TerminalGroup, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]": {
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Common.SortDirection": "Ascending" | "Descending";
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Common.DeliveryStatus": "Unconfirmed" | "WaitCooking" | "ReadyForCooking" | "CookingStarted" | "CookingCompleted" | "Waiting" | "OnWay" | "Delivered" | "Closed" | "Cancelled";
    /**
     * @description Delivery order statuses for update requests. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Common.DeliveryStatusForUpdate": "Waiting" | "OnWay" | "Delivered";
    /**
     * @description Sex. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Common.Gender": "NotSpecified" | "Male" | "Female";
    ...
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Common.PaymentAdditionalData"], "type">, "credential" | "searchScope">;
    /** @enum {string} */
    "iikoTransport.PublicApi.Contracts.Deliveries.Common.IikoCardSearchScope": "Reserved" | "Phone" | "CardNumber" | "CardTrack" | "PaymentToken" | "FindFaceId";
    /**
     * @description Order type. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Common.OrderServiceType": "Common" | "DeliveryByCourier" | "DeliveryByClient";
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Common.PaymentTypeKind": "Unknown" | "Cash" | "Card" | "Credit" | "Writeoff" | "Voucher" | "External" | "SmartSale" | "Sberbank" | "Trpos";
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Drafts.CommitDraftRequest": {
      ...
      createOrderSettings?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CreateOrderSettings"];
      /**
       * Format: uuid 
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Drafts.FilterDraftsResponse": {
      ...
      drafts: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Drafts.OrderDraft"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Drafts.GetDraftRequest": {
      ...
      /**
       * Format: uuid 
       * @description ID of the employee who wants to get this draft for editing.
       */
      employeeId: string;
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Drafts.GetDraftResponse": {
      ...
      order?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Order"] | null;
      /**
       * Format: uuid 
    ...
    /** @description Wrapping object (external) for a delivery order draft creation return. */
    "iikoTransport.PublicApi.Contracts.Deliveries.Drafts.SaveDraftResponse": {
      /**
       * Format: uuid 
       * @description Operation ID.
       */
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.AddOrderItemsRequest": {
       ...
       *  > Allowed from version `7.6.1`.
       */
      combos?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Combo"])[] | null;
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CloseTableOrderRequest": {
      /** @description Cheque additional information according to russian federal law #54. */
      chequeAdditionalInfo?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Common.ChequeAdditionalInfo"] | null;
      /**
       * Format: uuid 
       * @description Organization ID.
       *             
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.AnonymousCustomer": WithRequired<{
      ...
      name: string;
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Customer"], "type">, "name">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CardPayment": ({
       ...
       */
      number?: string | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Payment"], "paymentTypeKind">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CardTipsPayment": ({
       ...
       */
      number?: string | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.TipsPayment"], "paymentTypeKind">;
    /**
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CompoundOrderItem": WithRequired<({
      ...
      secondaryComponent?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CompoundOrderItemComponent"] | null;
      /** @description Indivisible modifiers. */
      commonModifiers?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Modifier"])[] | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderItem"], "type">, "primaryComponent">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CompoundOrderItemComponent": {
      ...
      modifiers?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Modifier"])[] | null;
      /**
       * Format: double 
       * @description Price.
       */
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.DeliveryPoint": {
       ...
       */
      coordinates?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Coordinates"] | null;
      /** @description Order delivery address. */
      address?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Address"] | null;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.DiscountsInfo": {
      /** @description Track of discount card to be applied to order. */
      card?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.DiscountCard"] | null;
      /**
       * @description Discounts/surcharges.
       * 
       *  > Type **iikoCard** allowed from version `7.4.4`.
       */
      discounts?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Discount"])[] | null;
    };
    ...
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Discount"], "type">, "programId" | "programName" | "discountItems">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Order": {
       ...
       */
      orderServiceType?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderServiceType"] | null;
      /**
       * @description Delivery point details.
       * > Not required in case of customer pickup. Otherwise, required.
       */
      deliveryPoint?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.DeliveryPoint"] | null;
      ...
      } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Customer"], "type">) | null;
      /** @description Guest details. Not equal to the customer who makes an order. */
      guests?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Guests"] | null;
      /**
       * Format: uuid 
       ...
       */
      payments?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Payment"])[] | null;
      /** @description Order tips components. */
      tips?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.TipsPayment"])[] | null;
      ...
      /** @description Discounts/surcharges. */
      discountsInfo?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.DiscountsInfo"] | null;
      /** @description Information about Loyalty app. */
      loyaltyInfo?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.LoyaltyInfo"] | null;
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderItem": {
      ...
      comboInformation?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.ComboItemInformation"] | null;
      /** @description Comment. */
      comment?: string | null;
    };
    /**
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderServiceType": "DeliveryByCourier" | "DeliveryByClient";
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Payment": {
      ...
      } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Common.PaymentAdditionalData"], "type">) | null;
      /**
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.ProductOrderItem": WithRequired<({
       ...
       */
      positionId?: string | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderItem"], "type">, "productId">;
    /**
    ...
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Customer"], "type">;
    /**
    ...
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Discount"], "type">, "discountTypeId">;
    /**
     * @description Street.
     * <remarks>
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrderRequest": {
      ...
      terminalGroupId?: string | null;
      /** @description Order creation parameters. */
      createOrderSettings?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.CreateOrderSettings"] | null;
      /** @description Order. */
      order: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Order"];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.OrdersByDeliveryDateAndFilterRequest": {
      ...
      statuses?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Common.DeliveryStatus"])[] | null;
      /**
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Request.OrderSortProperty": "Number" | "CompleteBefore" | "Sum" | "Customer" | "Courier" | "Status";
    ...
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.UpdateOrder.ChangeServiceTypeRequest"], "newServiceType">;
    ...
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.UpdateOrder.ChangeServiceTypeRequest"], "newServiceType">, "deliveryPoint">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.CheckCreateOrderResponse": {
      ...
      errorInfo: components["schemas"]["iikoTransport.PublicApi.Contracts.Errors.ErrorInfo"] | null;
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Address": {
      ...
      doorphone?: string | null;
      /** @description Region */
      region: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Region"] | null;
    };
    /**
     * @description 'One-time' customer:
     * - should be used if a customer does not agree to take part in the store's loyalty programs or an aggregator (external system) does not provide customer details
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.AnonymousCustomer": WithRequired<{
      ...
      /** @description Customer name. */
      name: string;
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Customer"], "type">, "name">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CompoundOrderItem": WithRequired<({
      ...
      secondaryComponent?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CompoundOrderItemComponent"] | null;
      /** @description Indivisible modifiers. */
      commonModifiers?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItemModifier"])[] | null;
      /** @description Modifier scheme. */
      template?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CompoundItemTemplate"] | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItem"], "type">, "primaryComponent">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CompoundOrderItemComponent": {
      ...
      /** @description Modifiers. */
      modifiers?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItemModifier"])[] | null;
      /**
       * Format: double 
       * @description Price per item unit. Can be sent different from the price in the base menu.
       */
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CreationStatus": "Success" | "InProgress" | "Error";
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.DeliveryPoint": {
      /** @description Delivery address coordinates. */
      coordinates?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Coordinates"] | null;
      /** @description Delivery address details. */
      address?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Address"] | null;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Order": {
      ...
      } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Customer"], "type">) | null;
       ...
       * </remarks>
       */
      deliveryPoint?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.DeliveryPoint"] | null;
       ...
       * </remarks>
       */
      cancelInfo?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CancelInfo"] | null;
      /** @description Driver information. */
      courierInfo?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.CourierInfo"] | null;
      /**
       * Format: yyyy-MM-dd HH:mm:ss.fff 
      ...
      comment?: string | null;
      /** @description Problem flag. */
      problem?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Problem"] | null;
      /** @description Operator that took order. */
      operator?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Employee"] | null;
      /** @description Marketing source. */
      marketingSource?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.MarketingSource"] | null;
      /**
       * Format: int64 
       ...
       */
      externalCourierService?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ExternalCourierService"] | null;
      /**
       * Format: uuid 
       * @description Tells that this delivery has been canceled and moved to terminal group
       * with id iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Order.MovedToTerminalGroupId.
       */
      ...
      /** @description Concept. */
      conception?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Conception"] | null;
      /** @description Information about order guests. */
      guestsInfo: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.GuestsInfo"] | null;
      /** @description Order items. */
      items: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItem"])[];
      /** @description Combo. */
      combos?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderCombo"])[] | null;
      /** @description Payments. */
      payments?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.PaymentItem"])[] | null;
      /** @description Tips. */
      tips?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.TipsPaymentItem"])[] | null;
      /** @description Discounts. */
      discounts?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.DiscountItem"])[] | null;
      /** @description Order type. */
      orderType: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderType"] | null;
      /**
       * Format: uuid 
       ...
       * </remarks>
       */
      loyaltyInfo?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.LoyaltyInfo"] | null;
    };
    /** @description Order base details. */
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderBase": {
      /**
       * Format: double 
       * @description Order amount (after discount or surcharge).
       */
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderInfo": {
       ...
       */
      order?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Order"] | null;
    };
    /** @description Order item. */
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItem": {
      ...
      deleted?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ItemDeletedInfo"] | null;
      /**
       * Format: double 
       * @description Quantity.
       */
      ...
      whenPrinted?: string | null;
      /** @description Size. */
      size?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ProductSize"] | null;
      /** @description Combo details, if order item is part of combo. */
      comboInformation?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ComboItemInformation"] | null;
    };
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItemModifier": {
      ...
      productGroup?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ProductGroup"] | null;
      /**
       * Format: double 
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItemStatus": "Added" | "PrintedNotCooking" | "CookingStarted" | "CookingCompleted" | "Served";
    /**
     * @description Describes the status of an order. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderStatus": "New" | "Bill" | "Closed" | "Deleted";
    /** @description Order type. */
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ProductOrderItem": WithRequired<({
       ...
       */
      taxPercent?: number | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItem"], "type">, "product" | "price" | "cost" | "pricePredefined">;
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.RegularCustomer": WithRequired<({
       ...
       */
      birthdate?: string | null;
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Customer"], "type">, "id" | "name">;
    /** @description Write-off type. */
    ...
    "iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.ServiceOrderItem": WithRequired<{
       ...
       */
      cost: number;
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItem"], "type">, "service" | "cost">;
    /** @description Street. */
     ...
     * @enum {integer}
     */
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.ActionOnValidationRejection": 1 | 2;
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.DeliveryRestrictionRejectCode": "Undefined" | "SumIsLessThenMinimum" | "DayOfWeekIsUnacceptable" | "DeliveryTimeIsUnacceptable" | "OutOfTerminalZone";
    ...
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.GetAllowedRestrictionsRequest": {
      ...
      deliveryAddress?: components["schemas"]["iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.RestrictionsAddress"] | null;
      /** @description Order location. */
      orderLocation?: components["schemas"]["iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.OrderLocation"] | null;
    ...
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.GetAllowedRestrictionsResponse": {
      ...
      location: components["schemas"]["iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.OrderLocation"] | null;
    ...
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.RejectItem": {
      ...
      rejectItemData?: components["schemas"]["iikoTransport.PublicApi.Contracts.DeliveryRestrictions.AllowedRestrictions.RejectItemData"] | null;
    };
    /** @description Reject additional information. */
     ...
     * @enum {integer}
     */
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.DeliveryGeocodeServiceType": 1 | 2 | 3 | 4;
     ...
     * @enum {integer}
     */
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.DeliveryRestrictionsMode": 0 | 1 | 2;
     ...
     * @enum {integer}
     */
    "iikoTransport.PublicApi.Contracts.DeliveryRestrictions.HousesRangeType": 0 | 1 | 2 | 3;
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Discounts.DiscountCardMode": "Percent" | "FlexibleSum" | "FixedSum";
    ...
    "iikoTransport.PublicApi.Contracts.Discounts.DiscountsResponse": {
      ...
      discounts: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Discounts.DiscountCardTypeInfo, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Employees.ActiveCourierLocationsResponse": {
      ...
      activeCourierLocations: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.ActiveCourierLocation, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Employees.CourierLocationsByTimeOffsetResponse": {
      ...
      courierLocations: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.CourierLocations, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Employees.EmployeesResponse": {
      ...
      employees: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.Employee, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.Employees.EmployeesWithRoleSignResponse": {
      ...
      correlationId: string;
      /** @description List of drivers. */
      employeesWithCheckRoles: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Employees.EmployeeWithCheckedRole, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    /** @description Employee DTO. */
    ...
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.AllowedItem": {
      /**
       * Format: uuid 
       * @description Organization ID.
       */
      ...
      /**
       * Format: int32 
       * @description Order duration in minutes.
       */
      orderDurationInMinutes?: number | null;
      /** @description Delivery zone name which this TerminalGroupId belongs to. */
      zone?: string | null;
      /** @description Link to "delivery service payment". */
      deliveryService?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.DeliveryService"] | null;
    };
    /** @description Delivery address. */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.DeliveryAddress": {
      /** @description City. */
      city?: string | null;
      /** @description Street. */
      streetName?: string | null;
    ...
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.DeliveryService": {
      /**
       * Format: uuid 
       * @description Product Id.
       */
    ...
    /** @description Request to identify suitable terminal groups(v2). */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.GetAllowedRestrictionsRequest": {
      /**
       * @description Organization IDs.
       *             
       * Can be obtained by `/api/1/organizations` operation.
      ...
      /** @description Order location. */
      orderLocation?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.OrderLocation"] | null;
      /** @description Delivery address. */
      deliveryAddress?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.DeliveryAddress"] | null;
      /** @description Type of delivery service. */
      orderServiceType: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.OrderServiceType"];
      /**
       * Format: double 
       * @description Sum.
       */
       ...
       */
      discountSum: number | null;
      /** @description Flag to return rejected points. */
      returnRejected?: boolean;
    };
    /** @description Response to identify suitable terminal groups (v2). */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.GetAllowedRestrictionsResponse": {
      /**
       * Format: uuid 
       * @description Operation ID.
       */
      ...
      allowedItems: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.AllowedItem"])[];
      /** @description Rejected items. */
      rejectedItems?: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.RejectedItem"])[] | null;
    };
    /** @description Delivery order location coordinates. */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.OrderLocation": {
      /**
       * Format: double 
       * @description Latitude.
       */
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.OrderServiceType": "DeliveryByCourier" | "DeliveryByClient" | "Common";
    /** @description Point reject cause. */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.RejectCause": {
      /** @description Reject code. */
      rejectCode?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.RejectCode"] | null;
      /** @description Reject hint. */
      rejectHint?: string | null;
    };
    /**
     * @description Reject points reasons. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.RejectCode": "SumIsUnacceptable" | "DeliveryDateIsUnacceptable" | "OutOfTerminalZone" | "TerminalGroupNotActive";
    /** @description Rejected point. */
    "iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.RejectedItem": {
      /**
       * Format: uuid 
       * @description Organization ID.
       */
      ...
      zone?: string | null;
      /** @description Reject causes. */
      rejectCauses: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebAllowedDeliveryRestrictions.RejectCause"])[];
    };
    /** @description Cost rule. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.CostRule": {
      /**
       * Format: int32 
       * @description Cost.
       */
    ...
    /** @description Delivery restrictions. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryRestrictions": {
      /**
       * Format: uuid 
       * @description Chain or singlRms crmId.
       */
      organizationId: string;
      /** @description Delivery service. */
      deliveryService?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryService"] | null;
      /** @description Delivery zone type. */
      deliveryZoneType?: string | null;
      /** @description Flag of delivery restrictions v2 enabled. */
      enable: boolean;
      /** @description Organization settings. */
      organizationSettings: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.Settings"])[];
    };
    /** @description Delivery service. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryService": {
      /**
       * Format: uuid 
       * @description Product Id.
       */
    ...
    /** @description Delivery zone. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryZone": {
      ...
      properties: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.ZoneProperties"];
    };
    /** @description Coordinates. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryZonePoint": {
      /**
       * Format: double 
       * @description Latitude.
       */
    ...
    /** @description Delivery zone settings. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryZoneSettings": {
      /**
       * Format: uuid 
       * @description UOC RMS ID.
       */
      organizationId: string;
      /** @description Order type. */
      type: string;
      /** @description Flag that zone is enabled. */
      active: boolean;
      /** @description Work intervals. */
      workIntervals?: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.WorkInterval"])[] | null;
      /** @description Delivery zone. */
      deliveryZone?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryZone"] | null;
      /** @description Zone name. */
      name?: string | null;
      /**
       * Format: int32 
    ...
    /** @description Request for delivery restrictions (v2). */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.GetDeliveryRestrictionsRequest": {
      /**
       * @description Organization IDs.
       *             
       * Can be obtained by `/api/1/organizations` operation.
    ...
    /** @description Response for delivery restrictions (v2). */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.GetDeliveryRestrictionsResponse": {
      /**
       * Format: uuid 
       * @description Operation ID.
       */
      correlationId: string;
      /** @description Delivery restrictions. */
      deliveryRestrictions: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryRestrictions"])[];
    };
    /** @description Delivery terminal groups settings for RMS. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.OrganizationTgDeliverySettings": {
      /** @description Flag of working with delivery. */
      enabled: boolean;
      /**
       * Format: uuid 
       * @description Terminal group ID.
      ...
      terminalGroupId?: string | null;
      /** @description Delivery zone settings. */
      deliveryZoneSettings?: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryZoneSettings"])[];
    };
    /** @description Terminal groups settings for RMS. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.OrganizationTgSettings": {
      /** @description Flag of working with this order type. */
      enabled: boolean;
      /**
       * Format: uuid 
       * @description Terminal group ID.
      ...
      /**
       * Format: int32 
       * @description Order duration (for pickup).
       */
      orderDuration?: number | null;
      /** @description Zone settings. */
      zoneSettings?: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.ZoneSettings"] | null;
    };
    /** @description RMS settings. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.Settings": {
      /**
       * Format: uuid 
       * @description UOC RMS ID.
       */
      ...
      delivery: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.OrganizationTgDeliverySettings"];
      /** @description Pickup settings. */
      pickup: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.OrganizationTgSettings"];
      /** @description Eat in settings. */
      eatin: components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.OrganizationTgSettings"];
    };
    /** @description Work intervals. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.WorkInterval": {
      /** @description Week days. */
      weekDays: (components["schemas"]["System.DayOfWeek"])[];
      /**
       * Format: date-span 
       ...
       */
      close: string;
      /** @description Cost rules. */
      costRules?: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.CostRule"])[] | null;
      /**
       * Format: int32 
    ...
    /** @description Zone properties. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.ZoneProperties": {
      /** @description Coordinates. */
      coordinates: (components["schemas"]["iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.DeliveryZonePoint"])[];
      /**
       * Format: int32 
    ...
    /** @description Zone settings. */
    "iikoTransport.PublicApi.Contracts.IikoWebDeliveryRestrictions.ZoneSettings": {
      /**
       * Format: uuid 
       * @description UOC RMS ID.
       */
    ...
    "iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.DeliveryOrderWebHooksFilter": {
      ...
      orderStatuses?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Common.DeliveryStatus"])[] | null;
      /** @description Statuses of order items, when changing which need to send a notification. */
      itemStatuses?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItemStatus"])[] | null;
    ...
    "iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.TableOrderWebHookFilter": {
      /** @description Statuses of orders, when changing which need to send a notification. */
      orderStatuses?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Orders.Common.OrderStatus"])[] | null;
      /** @description Statuses of order items, when changing which need to send a notification. */
      itemStatuses?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderItemStatus"])[] | null;
      /** @description Flag for updates. */
      errors?: boolean;
    ...
    "iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.WebHooksFilter": {
      /** @description Filter for delivery orders. */
      deliveryOrderFilter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.DeliveryOrderWebHooksFilter"] | null;
      /** @description Filter for table orders. */
      tableOrderFilter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.TableOrderWebHookFilter"] | null;
      /** @description Filter for banquets/reserves. */
      reserveFilter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.ReserveWebHookFilter"] | null;
      /** @description Filter for stop-lists changes. */
      stopListUpdateFilter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.WebHookShortFilter"] | null;
      /** @description Filter for personal shift. */
      personalShiftFilter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.WebHookShortFilter"] | null;
    };
    ...
    "iikoTransport.PublicApi.Contracts.Nomenclature.MenusDataResponse": {
      ...
      externalMenus?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Nomenclature.ExternalMenu"])[] | null;
      /** @description Price category. */
      priceCategories?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Nomenclature.PriceCategory"])[] | null;
    };
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Nomenclature.OrderItemType": "Product" | "Compound";
    ...
    "iikoTransport.PublicApi.Contracts.Notifications.OrderAttentionNotificationRequest": WithRequired<{
      ...
      /** @description Additional info about the problem. */
      additionalInfo: string;
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Notifications.SendNotificationRequest"], "messageType">, "orderSource" | "orderId" | "additionalInfo">;
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Orders.Common.OrderStatus": "New" | "Bill" | "Closed" | "Deleted";
    /**
     * @description Order service type. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.OrderTypes.OrderServiceType": "Common" | "DeliveryByCourier" | "DeliveryPickUp";
    /** @description Order type. */
    ...
    "iikoTransport.PublicApi.Contracts.OrderTypes.OrderTypesResponse": {
      ...
      orderTypes: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.OrderTypes.OrderType, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    /**
     * @description Address format type. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Organizations.AddressFormatType": "Legacy" | "City" | "International" | "IntNoPostcode";
    /**
     * @description Delivery settings service type. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Organizations.DeliverySettingsServiceType": "CourierOnly" | "SelfServiceOnly" | "CourierAndSelfService";
    ...
    "iikoTransport.PublicApi.Contracts.Organizations.ExtendedOrganizationInfo": WithRequired<({
      ...
      deliveryServiceType: components["schemas"]["iikoTransport.PublicApi.Contracts.Organizations.DeliverySettingsServiceType"] | null;
      /**
       * Format: uuid 
    ...
    }) & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Organizations.OrganizationInfo"], "responseType">, "country" | "restaurantAddress" | "latitude" | "longitude" | "useUaeAddressingSystem" | "version" | "currencyIsoName" | "currencyMinimumDenomination" | "countryPhoneCode" | "marketingSourceRequiredInDelivery" | "defaultDeliveryCityId" | "deliveryCityIds" | "deliveryServiceType" | "defaultCallCenterPaymentTypeId" | "orderItemCommentEnabled" | "inn" | "addressFormatType" | "isConfirmationEnabled" | "confirmAllowedIntervalInMinutes" | "isCloud" | "addressLookup">;
    ...
    "iikoTransport.PublicApi.Contracts.Organizations.SimpleOrganizationInfo": {
      responseType: "Simple";
    } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Organizations.OrganizationInfo"], "responseType">;
    /**
     * @description Payment processing type. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.PaymentTypes.PaymentProcessingType": "External" | "Internal" | "Both";
    ...
    "iikoTransport.PublicApi.Contracts.PaymentTypes.PaymentType": {
      ...
      paymentProcessingType?: components["schemas"]["iikoTransport.PublicApi.Contracts.PaymentTypes.PaymentProcessingType"] | null;
      /** @description Payment type category. */
      paymentTypeKind?: components["schemas"]["iikoTransport.PublicApi.Contracts.PaymentTypes.PaymentTypeKind"] | null;
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.PaymentTypes.PaymentTypeKind": "Unknown" | "Cash" | "Card" | "Credit" | "Writeoff" | "Voucher" | "External" | "IikoCard";
    ...
    "iikoTransport.PublicApi.Contracts.Reserves.CreateReserveRequest": {
      ...
      order?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderBase"] | null;
      /** @description Customer. */
      ...
      guests?: components["schemas"]["iikoTransport.PublicApi.Contracts.Reserves.GuestsInfo"] | null;
    };
    /** @description Font. */
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Reserves.FontStyle": "Regular" | "Bold" | "Italic" | "Underline" | "Strikeout";
    ...
    "iikoTransport.PublicApi.Contracts.Reserves.Reserve": {
      ...
      } & Omit<components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Customer"], "type">;
      /**
       * Format: int32 
      ...
      cancelReason?: components["schemas"]["iikoTransport.PublicApi.Contracts.Reserves.ReserveCancelReason"] | null;
      ...
      phone?: string | null;
      /** @description Order. Used only at a banquet. */
      order?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.OrderBase"] | null;
    };
    /**
     * @description Reason why planned event failed. 
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Reserves.ReserveCancelReason": "ClientNotAppeared" | "ClientRefused" | "Other";
    /** @description Banquet/reserve. */
    "iikoTransport.PublicApi.Contracts.Reserves.ReserveInfo": {
      ...
      isDeleted: boolean;
      /** @description Banquet/reserve. */
      reserve?: components["schemas"]["iikoTransport.PublicApi.Contracts.Reserves.Reserve"] | null;
    };
    /** @description Banquet/reserve. */
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.Reserves.ReserveStatus": "New" | "Started" | "Closed";
    ...
    "iikoTransport.PublicApi.Contracts.Reserves.RestaurantSection": {
      ...
      schema?: components["schemas"]["iikoTransport.PublicApi.Contracts.Reserves.SectionSchema"] | null;
    };
    ...
    "iikoTransport.PublicApi.Contracts.StopLists.StopListsResponse": {
      ...
      terminalGroupStopLists: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.StopLists.TerminalGroupStopList, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    ...
    "iikoTransport.PublicApi.Contracts.TableOrders.Request.GetTableOrdersByTableRequest": {
      ...
      statuses?: (components["schemas"]["iikoTransport.PublicApi.Contracts.Orders.Common.OrderStatus"])[] | null;
      /**
       * Format: yyyy-MM-dd HH:mm:ss.fff 
    ...
    "iikoTransport.PublicApi.Contracts.TableOrders.Request.TableOrder": {
       ...
       */
      customer?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.RegularCustomer"] | null;
      /**
       ...
       *  > Allowed from version `7.6.1`.
       */
      guests?: components["schemas"]["iikoTransport.PublicApi.Contracts.TableOrders.Request.GuestsInfo"] | null;
      /**
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.TableOrders.Response.SplitOrderBetweenCashRegisters": "Disabled" | "Allowed" | "Required";
    /** @description Order. */
    "iikoTransport.PublicApi.Contracts.TableOrders.Response.TableOrder": {
       ...
       *  > Allowed from version `7.5.2`.
       */
      customer?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.RegularCustomer"] | null;
      /**
       * @description Guest phone.
       * 
       *  > Allowed from version `7.5.2`.
      ...
      waiter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.Employee"] | null;
      /** @description Tab name (only for fastfood terminals group in tab mode). */
      tabName?: string | null;
      /**
       * @description Need to split order between cash registers.
       ...
       * </remarks>
       */
      splitOrderBetweenCashRegisters?: components["schemas"]["iikoTransport.PublicApi.Contracts.TableOrders.Response.SplitOrderBetweenCashRegisters"] | null;
      /**
       * Format: double 
       * @description Order amount (after discount or surcharge).
       */
    ...
    "iikoTransport.PublicApi.Contracts.TableOrders.Response.TableOrderInfo": {
       ...
       * > Field is filled up if "creationStatus"="Success".
       */
      order?: components["schemas"]["iikoTransport.PublicApi.Contracts.TableOrders.Response.TableOrder"] | null;
    };
    /** @description Wrapping object (external) for a delivery order return. */
    ...
    "iikoTransport.PublicApi.Contracts.Terminals.TerminalGroupsResponse": {
      ...
      terminalGroups: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Terminals.TerminalGroup, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
      /**
       ...
       */
      terminalGroupsInSleep: (components["schemas"]["iikoTransport.PublicApi.Contracts.Common.RmsItemsResponseWrapper`1[[iikoTransport.PublicApi.Contracts.Terminals.TerminalGroup, iikoTransport.PublicApi.Contracts, Version=8.5.2.3, Culture=neutral, PublicKeyToken=null]]"])[];
    };
    /** @description Tips type. */
    ...
    "iikoTransport.PublicApi.Contracts.WebHooks.GetWebHookSettingsResponse": {
      ...
      /** @description Webhooks filter. */
      webHooksFilter?: components["schemas"]["iikoTransport.PublicApi.Contracts.Integration.WebHooksFilters.WebHooksFilter"] | null;
    };
     ...
     * @enum {string}
     */
    "iikoTransport.PublicApi.Contracts.WebHooks.WebHookEventType": "DeliveryOrderUpdate" | "DeliveryOrderError" | "ReserveUpdate" | "ReserveError" | "TableOrderUpdate" | "TableOrderError" | "StopListUpdate" | "PersonalShift";
